...
public class BDao {
	...
	public ArrayList<Bvo> list() {
		...
		ArrayList<Bvo> vos = new ArrayList<Bvo>();
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		...
		try {
			...
			while (resultSet.next()) {
				...
				Bvo vo = new Bvo(bId, bName, bTitle, bContent, bDate, bHit,
	...
	public Bvo contentView(String strID) {
		...
		try {
			...
			if (resultSet.next()) {
				...
				vo = new Bvo(bId, bName, bTitle, bContent, bDate, bHit, bGroup,
						bStep, bIndent);
			}
